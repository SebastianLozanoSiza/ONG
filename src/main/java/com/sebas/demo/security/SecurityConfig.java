...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JWTValidationFilter jwtValidationFilter)
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/reportes").hasRole("AUXILIAR")
                .requestMatchers("/envios", "/reportes", "/sedes", "/socios", "/voluntarios").hasRole("ADMIN")
                .requestMatchers("/socios", "/voluntarios", "/envios").hasRole("DIRECTOR")
